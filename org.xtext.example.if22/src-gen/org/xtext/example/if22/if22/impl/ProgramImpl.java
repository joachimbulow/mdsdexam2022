...
public class ProgramImpl extends MinimalEObjectImpl.Container implements Program
{
  ...
  {
    return If22Package.Literals.PROGRAM;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, If22Package.PROGRAM__NAME, oldName, name));
  }
  ...
  public EList<Scenario> getScenarios()
  {
    if (scenarios == null)
    {
      scenarios = new EObjectContainmentEList<Scenario>(Scenario.class, this, If22Package.PROGRAM__SCENARIOS);
    }
    return scenarios;
  }
